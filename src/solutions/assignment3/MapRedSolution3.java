...
public class MapRedSolution3
{
    ...
    public static class WriteThrough extends Reducer<Text, NullWritable, Text, NullWritable> {
        @Override
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        job.setMapperClass(ExtractCnameIdentity.class);
        job.setReducerClass(WriteThrough.class);
